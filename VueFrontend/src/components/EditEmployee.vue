      ...
      <div class="wrap-contact100">
        <form class="contact100-form validate-form">
          ...
          <div class="container-contact100-form-btn">
            <button class="contact100-form-btn" v-on:click="changeEmployee">
						<span>
...
<script>
  export default {
    ...
    created() {
      ...
      fetch('http://localhost:1871/employees/'+this.id)
        .then(response => response.json())
        .then(data => {
            console.log('GET EMPLOYEE::'+this.id)
            console.log(data)
    ...
    methods: {
      changeEmployee: function () {
        ...
        fetch('http://localhost:6969/employees/' + this.id, requestOptions)
