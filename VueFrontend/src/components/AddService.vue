      ...
      <div class="wrap-contact100">
        <form class="contact100-form validate-form">
          ...
          <div class="wrap-input100 validate-input">
            <input class="input100" type="text" v-model="serviceName" placeholder="Tätigkeit">
            <span class="focus-input100"></span>
          </div>


          <select class="input100" v-model="selectedEmployee" v-on:change="onChangeEmployee">
          ...
          <div class="wrap-input100 validate-input">
            <input class="input100" type="datetime-local" v-model="date" placeholder="Datum">
            <span class="focus-input100"></span>
          </div>
          ...
          <div class="container-contact100-form-btn">
            <button class="contact100-form-btn" v-on:click="addService()">
						<span>
  ...
  export default {
    ...
    methods: {
      addService: function () {
        ...
        fetch('http://localhost:6969/services', requestOptions)
      ...
      onChangeEmployee: function () {
        console.log('EMPLOYEE CHANGED -->' + this.selectedEmployee);
      }
